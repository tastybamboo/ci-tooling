...
- `ruby-3.2-rails-7.2.3.2`
- `ruby-3.2-rails-8.0.5.1`
- `ruby-3.2-rails-8.1.3.1`

**Ruby 3.3** (works with all Rails versions):
- `ruby-3.3-rails-7.0.10`
- `ruby-3.3-rails-7.1.6`
- `ruby-3.3-rails-7.2.3.2`
- `ruby-3.3-rails-8.0.5.1`
- `ruby-3.3-rails-8.1.3.1`

**Ruby 3.4** (works with Rails 7.1+):
- `ruby-3.4-rails-7.1.6`
- `ruby-3.4-rails-7.2.3.2`
- `ruby-3.4-rails-8.0.5.1`
- `ruby-3.4-rails-8.1.3.1`
...
- `rails-7.0-latest` → Ruby 3.2 + Rails 7.0.7.0.10.0.10
- `rails-7.1-latest` → Ruby 3.2 + Rails 7.1.7.1.6.1.6
- `rails-7.2-latest` → Ruby 3.2 + Rails 7.2.7.2.3.2.2.3
- `rails-8.0-latest` → Ruby 3.3 + Rails 8.0.8.0.5.1.0.4
- `rails-8.1-latest` → Ruby 3.3 + Rails 8.1.8.1.3.1.1.2
- `rails-latest` → Ruby 3.4 + Rails 8.1.8.1.3.1.1.2